package com.equitybot.trade.messaging.kafka.config.consumer;
...
public class KafkaConsumerOrderServiceConfig {
   ...
   // private String groupId;
	...
	public Map<String, Object> consumerConfigs() {
		...
		propsMap.put(ConsumerConfig.GROUP_ID_CONFIG, "order-managemnt-group");
